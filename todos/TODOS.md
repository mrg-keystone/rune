...
Sequential. Each item ends with its verification step. keep ships before rune within any item that spans both repos. Repos: `~/Documents/programming/rune/keep` (this one) and `~/Documents/programming/rune`.
