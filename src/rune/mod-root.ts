...
export const rules: RuleDefinition[] = [
  ...
  { name: "no-dto-cast", description: "Coordinators must validate seams with assert(XxxDto, ...) — no blind `as XxxDto` casts", check: noDtoCast.check, systemPrompt: noDtoCast.SYSTEM_PROMPT, buildPrompt: noDtoCast.buildPrompt },
