...
`jsr:@mrg-keystone/rune@^3` (they live outside this repo) — that is intentional and
...
`jsr:@mrg-keystone/rune@^3/assert` in generated user projects). The lockstep guard
