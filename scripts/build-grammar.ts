...
//   1. generate.mjs          lang/keywords.json -> lang/grammar/grammar.js + lang/queries/highlights.scm
...
//
// This file lives in scripts/, so HERE is scripts/ and repo paths are one up (`../`).
